...
pub async fn agent_encrypt(arg1: &[u8], arg2: &u64) -> Vec<u8> {
    let mut client = agent_client::AgentClient::connect("http://127.0.0.1:50051").await.unwrap();
    let request = tonic::Request::new(EncryptRequest { arg1: arg1.to_vec(), arg2: Some(SecretId{keyid: *arg2,})});
...
pub async fn agent_decrypt(arg1: &[u8], arg2: &u64) -> Vec<u8> {
    let mut client = agent_client::AgentClient::connect("http://127.0.0.1:50051").await.unwrap();
    let request = tonic::Request::new(DecryptRequest { arg1: arg1.to_vec(), arg2: Some(SecretId{ keyid: *arg2})});
